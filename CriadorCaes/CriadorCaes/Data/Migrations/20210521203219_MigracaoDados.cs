        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodPostal = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    Email = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    Telemovel = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VeterinariosId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Caes_Veterinarios_VeterinariosId",
            ...
            migrationBuilder.InsertData(
                table: "Caes",
                columns: new[] { "Id", "DataNasc", "LOP", "Nome", "RacaFK", "Sexo", "VeterinariosId" },
                values: new object[,]
                {
                    { 1, new DateTime(2019, 4, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "LOP446793", "Aguia da Quinta do Conde", 1, "F", null },
                    { 2, new DateTime(2019, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "LOP446795", "Aileen da Quinta do Lordy", 1, "F", null },
                    { 5, new DateTime(2012, 8, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "LOP446807", "Alabaster da Casa do Sobreiral", 2, "F", null },
                    { 7, new DateTime(2010, 12, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "LOP446811", "Gardenia da Tapada de Cima", 3, "F", null },
                    { 10, new DateTime(2017, 3, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "LOP446814", "Garfunkle da Quinta do Lordy", 4, "F", null },
                    { 3, new DateTime(2011, 3, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "LOP446801", "Aladim do Canto do Bairro Pimenta", 5, "F", null },
                    { 4, new DateTime(2008, 6, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "LOP446804", "Albert do Canto do Bairro Pimenta", 5, "F", null },
                    { 6, new DateTime(2010, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "LOP446809", "Gannett do Quintal de Cima", 6, "F", null },
                    { 8, new DateTime(2013, 4, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "LOP446799", "Forte da Flecha do Indio", 7, "F", null },
                    { 9, new DateTime(2011, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "LOP446812", "Garbo da Flecha do Indio", 7, "M", null },
                    { 11, new DateTime(2018, 1, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "LOP446816", "Garnet do Quintal de Cima", 8, "M", null }
                });
